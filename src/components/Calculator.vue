...
<div id="calc">
  <form id="exForm" onsubmit="return false" class="centered">
    <div class="row justify-content-center">
      <div class="form-group col-md-6">
        ...
        <input type="number" step="0.01" class="form-control" id="inputEUR" name="amount" v-model="form.amount" @blur="calculateProp()">
      </div>
      <div class="form-group col-md-4">
        <label for="inputTarget">Target</label>
        <select class="form-control" id="inputTarget" name="target" v-model="form.target" @blur="calculateProp()">
  ...
  <div class="exchangeInfo">
    <div class="row justify-content-center">
      <div class="mx-auto">
        <div id="exInfo" class="alert alert-primary" role="alert" style="display:none"/>
      </div>
    </div>
  </div>
</div>
